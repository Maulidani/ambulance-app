...
object MessageUtils {
    ...
    const val MSG_DELETE_SUCCESS = "Delete account succed."
    const val MSG_DELETE_ACCOUNT_CONFIRM = "Are you sure you want to delete this account?."
    const val MSG_EDIT_CONFIRM = "Are you sure you want to edit this form?."
    ...
    const val MSG_SUCCESS_UPDATE_PROFILE = "Success update profile."
    ...
    const val MSG_COOMING_SOON = "Cooming soon."
